#ifndef INCLUDE_ASTRUM_VERA_FONT
#define INCLUDE_ASTRUM_VERA_FONT

namespace Astrum {

  const unsigned char _Vera_ttf[] = {
  ...
  const int _Vera_ttf_len = 65932;

}; // namespace Astrum

#endif // ifndef INCLUDE_ASTRUM_VERA_FONT
