 ...
 */
/*
 * Modified 2022 by Benjamin Kelley
 */
#ifndef INCBIN_HDR
#define INCBIN_HDR
#include <limits.h>
...
#  define INCBIN_SECTION(SECT)   SECT "\n"
...
#  define INCBIN_TYPE(...)
#else
#  define INCBIN_SECTION(SECT)   ".section " SECT "\n"
...
#  define INCBIN_COMMON(TYPE, NAME, FILENAME, TERMINATOR) \
    __asm__(INCBIN_SECTION(INCBIN_OUTPUT_DATA_SECTION) \
            ...
            INCBIN_MANGLE INCBIN_STRINGIZE(INCBIN_PREFIX) #NAME INCBIN_STYLE_STRING(END) ":\n" \
                INCBIN_BYTE "1\n" \
            INCBIN_SECTION(INCBIN_OUTPUT_SIZE_SECTION) \
